...
namespace XK.PanGuSearch {
    ...
    public class Doc : IndexManage {
        ...
        private Query query(Analyzer analyzer) {
            ...
            QueryParser qp = new MultiFieldQueryParser(Lucene.Net.Util.Version.LUCENE_30, SearchModel.Fields, analyzer);
            Query query = qp.Parse(SearchModel.Words);
            return query;
        }
        ...
        private List<Document> ScoreDocs2Doc(IndexSearcher searcher, IEnumerable<ScoreDoc> scoreDocs) {
            ...
            Analyzer analyzer = GetAnalyzer();
            Highlighter highlighter = new Highlighter(htmlFormatter,new Segment());
        ...
        private Document ScoreDoc2Document(IndexSearcher searcher, ScoreDoc scoreDoc, Highlighter highlighter,
            ...
            foreach (IFieldable field in fields) {
                ...
                string text = highlighter.GetBestFragment(SearchModel.Words, value)??"";
